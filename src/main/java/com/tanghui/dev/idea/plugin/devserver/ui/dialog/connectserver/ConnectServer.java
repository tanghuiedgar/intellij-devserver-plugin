...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        root.setMaximumSize(new Dimension(400, 300));
        ...
        panel1.setMaximumSize(new Dimension(2147483647, 220));
        panel1.setMinimumSize(new Dimension(24, 220));
        panel1.setPreferredSize(new Dimension(24, 220));
        ...
        panel4.setMaximumSize(new Dimension(260, 2147483647));
        panel4.setMinimumSize(new Dimension(260, 24));
        panel4.setPreferredSize(new Dimension(260, 24));
        panel3.add(panel4, BorderLayout.WEST);
        final JBPanel panel5 = new JBPanel();
        panel5.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        panel5.setMaximumSize(new Dimension(70, 2147483647));
        panel5.setMinimumSize(new Dimension(70, 24));
        panel5.setPreferredSize(new Dimension(70, 24));
        ...
        panel6.add(serverHost, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        panel11.setMaximumSize(new Dimension(70, 2147483647));
        panel11.setMinimumSize(new Dimension(70, 24));
        panel11.setPreferredSize(new Dimension(70, 24));
        ...
        panel12.add(serverUser, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final JBPanel panel13 = new JBPanel();
        panel13.setLayout(new BorderLayout(0, 0));
        panel1.add(panel13, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JBPanel panel14 = new JBPanel();
        panel14.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        panel14.setMaximumSize(new Dimension(70, 2147483647));
        panel14.setMinimumSize(new Dimension(70, 24));
        panel14.setPreferredSize(new Dimension(70, 24));
        ...
        panel15.add(serverPassword, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final JBPanel panel16 = new JBPanel();
        panel16.setLayout(new BorderLayout(0, 0));
        panel1.add(panel16, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JBPanel panel17 = new JBPanel();
        panel17.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        panel17.setMaximumSize(new Dimension(70, 2147483647));
        panel17.setMinimumSize(new Dimension(70, 24));
        panel17.setPreferredSize(new Dimension(70, 24));
        ...
        panel18.add(serverGroupBy, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final JBPanel panel19 = new JBPanel();
        panel19.setLayout(new BorderLayout(0, 0));
        panel1.add(panel19, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JBPanel panel20 = new JBPanel();
        panel20.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        panel20.setMaximumSize(new Dimension(70, 2147483647));
        panel20.setMinimumSize(new Dimension(70, 24));
        panel20.setPreferredSize(new Dimension(70, 24));
        ...
        panel21.add(describe, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
