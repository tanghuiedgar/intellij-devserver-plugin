...
public class ExecuteRightComponent {
    ...
    public void createUIComponents() {
        ...
        this.executeCommand.setFont(EditorUtil.getEditorFont());
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.setMinimumSize(JBUI.size(0, 30));
        panel1.setPreferredSize(JBUI.size(0, 30));
        ...
        panel3.setMaximumSize(JBUI.size(2147483647, 80));
        panel3.setMinimumSize(JBUI.size(24, 80));
        panel3.setPreferredSize(JBUI.size(24, 80));
        ...
        panel6.add(directoryTextField, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, JBUI.size(150, -1), null, 0, false));
        ...
        panel9.add(userTextField, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, JBUI.size(150, -1), null, 0, false));
        ...
        panel11.setMaximumSize(JBUI.size(2147483647, 300));
        panel11.setMinimumSize(JBUI.size(24, 100));
        panel11.setPreferredSize(JBUI.size(24, 100));
        ...
        panel13.setMaximumSize(JBUI.size(2147483647, 35));
        panel13.setMinimumSize(JBUI.size(24, 35));
        panel13.setPreferredSize(JBUI.size(24, 35));
        ...
        panel14.add(scriptType, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, JBUI.size(-1, 25), JBUI.size(-1, 25), JBUI.size(-1, 25), 0, false));
        final JBPanel panel15 = new JBPanel();
        panel15.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        panel15.setMaximumSize(JBUI.size(35, 2147483647));
        panel15.setMinimumSize(JBUI.size(35, 24));
        panel15.setPreferredSize(JBUI.size(35, 24));
        panel13.add(panel15, BorderLayout.EAST);
        editorButton = new JButton();
        editorButton.setAutoscrolls(true);
        editorButton.setText("");
        panel15.add(editorButton, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, JBUI.size(30, 30), JBUI.size(30, 30), JBUI.size(30, 30), 0, false));
