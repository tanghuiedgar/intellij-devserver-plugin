...
public class LastRightComponent {
    ...
    private void $$$setupUI$$$() {
        ...
        connectionOperationToolbar.setMaximumSize(new Dimension(2147483647, 30));
        connectionOperationToolbar.setMinimumSize(new Dimension(24, 30));
        connectionOperationToolbar.setPreferredSize(new Dimension(24, 30));
        ...
        panel2.setMaximumSize(new Dimension(2147483647, 70));
        panel2.setMinimumSize(new Dimension(24, 70));
        panel2.setPreferredSize(new Dimension(24, 70));
        ...
        panel12.setMaximumSize(new Dimension(2147483647, 30));
        panel12.setMinimumSize(new Dimension(24, 30));
        panel12.setPreferredSize(new Dimension(24, 30));
