...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        workDirectory.setMinimumSize(new Dimension(0, 40));
        workDirectory.setPreferredSize(new Dimension(0, 40));
        ...
        panel1.add(targetDirectoryTextField, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final JBPanel panel2 = new JBPanel();
        panel2.setLayout(new BorderLayout(0, 0));
        panel2.setMaximumSize(new Dimension(2147483647, 200));
        panel2.setMinimumSize(new Dimension(24, 200));
        panel2.setPreferredSize(new Dimension(24, 200));
        ...
        panel4.setMaximumSize(new Dimension(2147483647, 30));
        panel4.setMinimumSize(new Dimension(24, 30));
        panel4.setPreferredSize(new Dimension(24, 30));
        ...
        shellScriptButton.setMaximumSize(new Dimension(30, 30));
        shellScriptButton.setMinimumSize(new Dimension(30, 30));
        shellScriptButton.setPreferredSize(new Dimension(30, 30));
        ...
        shellEditScriptButton.setMaximumSize(new Dimension(30, 30));
        shellEditScriptButton.setMinimumSize(new Dimension(30, 30));
        shellEditScriptButton.setPreferredSize(new Dimension(30, 30));
        ...
        panel7.setMaximumSize(new Dimension(2147483647, 30));
        panel7.setMinimumSize(new Dimension(24, 30));
        panel7.setPreferredSize(new Dimension(24, 30));
        ...
        rollbackScriptButton.setMaximumSize(new Dimension(30, 30));
        rollbackScriptButton.setMinimumSize(new Dimension(30, 30));
        rollbackScriptButton.setPreferredSize(new Dimension(30, 30));
        ...
        rollbackEditScriptButton.setMaximumSize(new Dimension(30, 30));
        rollbackEditScriptButton.setMinimumSize(new Dimension(30, 30));
        rollbackEditScriptButton.setPreferredSize(new Dimension(30, 30));
