...
public class ExecuteScript implements Disposable {
    ...
    public ExecuteScript(Project project, List<DevServerRunConfig> runConfigList, DevServerRunConfig runConfig) {
        ...
        // 回退脚本
        this.rollbackScriptOnOff.setOnText(DevServerBundle.INSTANCE.message("script"));
        this.rollbackScriptOnOff.setOffText(DevServerBundle.INSTANCE.message("command"));
        // 执行脚本
        this.shellScriptOnOff.setOnText(DevServerBundle.INSTANCE.message("script"));
        this.shellScriptOnOff.setOffText(DevServerBundle.INSTANCE.message("command"));
        initTextField();
        actionListener();
    }
    ...
    private void actionListener() {
        ...
        this.shellScriptButton.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                runShellScriptDialog.setTitle(DevServerBundle.INSTANCE.message("generic.run.script"));
        ...
        this.rollbackScriptButton.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                runShellScriptDialog.setTitle(DevServerBundle.INSTANCE.message("generic.fallback.script"));
        ...
        this.shellEditScriptButton.addActionListener(new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                EditScriptDialog runShellScriptDialog = new EditScriptDialog(project, DevServerBundle.INSTANCE.message("run.script"), StringUtils.isNotBlank(shellScriptEditor.getText().trim()) ? shellScriptEditor.getText().trim() : "");
                runShellScriptDialog.setTitle(DevServerBundle.INSTANCE.message("edit.run.script"));
        ...
        this.rollbackEditScriptButton.addActionListener(new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                EditScriptDialog runShellScriptDialog = new EditScriptDialog(project, DevServerBundle.INSTANCE.message("fallback.script"), StringUtils.isNotBlank(rollbackScriptTextEditor.getText().trim()) ? rollbackScriptTextEditor.getText().trim() : "");
                runShellScriptDialog.setTitle(DevServerBundle.INSTANCE.message("edit.fallback.script"));
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        shellScriptButton.setToolTipText(DevServerBundle.INSTANCE.message("view.generic.script"));
        ...
        shellEditScriptButton.setToolTipText(DevServerBundle.INSTANCE.message("edit"));
        ...
        rollbackScriptButton.setToolTipText(DevServerBundle.INSTANCE.message("view.generic.script"));
        ...
        rollbackEditScriptButton.setToolTipText(DevServerBundle.INSTANCE.message("edit"));
