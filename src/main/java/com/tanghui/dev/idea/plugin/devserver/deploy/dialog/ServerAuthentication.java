...
public class ServerAuthentication {
    ...
    private void $$$setupUI$$$() {
        ...
        root.setMinimumSize(new Dimension(500, 300));
        ...
        panel2.setMaximumSize(new Dimension(2147483647, 170));
        panel2.setMinimumSize(new Dimension(24, 170));
        panel2.setPreferredSize(new Dimension(24, 170));
        panel1.add(panel2, BorderLayout.NORTH);
        final JBPanel panel3 = new JBPanel();
        panel3.setLayout(new BorderLayout(0, 0));
        panel3.setMaximumSize(new Dimension(470, 50));
        panel3.setMinimumSize(new Dimension(470, 50));
        panel3.setPreferredSize(new Dimension(470, 50));
        panel2.add(panel3);
        final JBPanel panel4 = new JBPanel();
        panel4.setLayout(new BorderLayout(0, 0));
        panel4.setMaximumSize(new Dimension(330, 2147483647));
        panel4.setMinimumSize(new Dimension(330, 24));
        panel4.setPreferredSize(new Dimension(330, 24));
        ...
        panel8.setMaximumSize(new Dimension(70, 2147483647));
        panel8.setMinimumSize(new Dimension(70, 24));
        panel8.setPreferredSize(new Dimension(70, 24));
        ...
        panel10.setMaximumSize(new Dimension(470, 50));
        panel10.setMinimumSize(new Dimension(470, 50));
        panel10.setPreferredSize(new Dimension(470, 50));
        panel2.add(panel10);
        ...
        panel12.setMaximumSize(new Dimension(80, 2147483647));
        panel12.setMinimumSize(new Dimension(80, 24));
        panel12.setPreferredSize(new Dimension(80, 24));
        ...
        panel15.setMaximumSize(new Dimension(100, 2147483647));
        panel15.setMinimumSize(new Dimension(100, 24));
        panel15.setPreferredSize(new Dimension(100, 24));
        ...
        panel17.setMaximumSize(new Dimension(470, 50));
        panel17.setMinimumSize(new Dimension(470, 50));
        panel17.setPreferredSize(new Dimension(470, 50));
        panel2.add(panel17);
        final JBPanel panel18 = new JBPanel();
        panel18.setLayout(new BorderLayout(0, 0));
        panel18.setMaximumSize(new Dimension(250, 2147483647));
        panel18.setMinimumSize(new Dimension(250, 24));
        panel18.setPreferredSize(new Dimension(250, 24));
        ...
        panel19.setMaximumSize(new Dimension(80, 2147483647));
        panel19.setMinimumSize(new Dimension(80, 24));
        panel19.setPreferredSize(new Dimension(80, 24));
        ...
        panel21.setMaximumSize(new Dimension(80, 2147483647));
        panel21.setMinimumSize(new Dimension(80, 24));
        panel21.setPreferredSize(new Dimension(80, 24));
        panel17.add(panel21, BorderLayout.EAST);
        joinButton = new JButton();
        joinButton.setText("连接");
        panel21.add(joinButton, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, new Dimension(80, -1), new Dimension(80, -1), new Dimension(80, -1), 0, false));
    ...
    private void createUIComponents() {
        ...
        serverTextField.getEditor().getEditorComponent().setFont(new Font("Monaco", Font.PLAIN, 16));
        ...
        serverTextField.setPreferredSize(new Dimension(-1, 30));
